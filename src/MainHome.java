...
public class MainHome extends javax.swing.JFrame {
        ...
        setLocation(x, y);
         setTitle("Welcome to Parking Booking ");
        setResizable(false);try {
    ...
    private void initComponents() {
        ...
        jButton2.setBounds(70, 140, 300, 50);
        ...
        jButton3.setBounds(80, 230, 300, 50);

        lb_background.setText("jLabel1");
        getContentPane().add(lb_background);
        lb_background.setBounds(4, 0, 560, 400);
